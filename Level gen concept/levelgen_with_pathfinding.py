...
def method_one():
    ...
    while not success:
        ...
        while x<width-1:
            ...
            #make right twice as likely    ---edit: it's more interesting without this!
        ...
        while x<width-1 and runs<100:
            ...
            if x==width-1:
                success = True
                for i in range(height): #prevent straight line puzzles... thats no fun!
                    all_ones=True
                    ...
                    if all_ones:
                        success = False
                        print("err: straight line")
                all_zeros=True
                for i in range(height): #ensure last col has an exit: this may be unnecessary?
